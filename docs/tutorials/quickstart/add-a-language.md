...
<details>
<summary>Final code: the complete <code>main.tf</code></summary>

The entire `main.tf` after adding the Ruby option:
...
<details>
<summary>Final code: the complete <code>install-languages.sh.tftpl</code></summary>

The entire `install-languages.sh.tftpl` after adding the Ruby branch:
